...
if (isset($_POST['appointment_id'])) {
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        // Insert the appointment details into the scheduled_table with user_id
        $insertQuery = "INSERT INTO scheduled_table (user_id, priority, student_name, student_number, date, time, program, year, section, contactnumber, email, comment, communication) 
        ...
        if (mysqli_query($conn, $insertQuery)) {
            ...
            // Failed to insert appointment into scheduled_table
            echo "error_insert";
        }
    } else {
