...
<main class="main">
  ...
  <img src="images/pics/ftf1.svg" class="card-img-top">
  <div class="card-body">
    <h2 class="card-text align-text-justified"> In person consultaion</h2>
    <p class="card-text">We believe in the power of face-to-face interaction. Our in-person counseling sessions offer a unique opportunity to connect with your therapist in a comfortable and private setting. This direct interaction allows for a deeper level of understanding and a more personalized approach to your mental health journey</p>
  </div>
</div>
</div>
...
<div class="col-4">
             <div class="card" style="width: 35rem;">
  <img src="images/pics/online-1.svg" class="card-img-top">
  <div class="card-body">
  <h2 class="card-text"> Virtual Consultation</h2>
    <p class="card-text">In today's fast-paced world, finding time for self-care and mental health support can be challenging. Our virtual counseling sessions provide a convenient and effective way to access professional support from the comfort of your home or any private space.</p>
  </div>
</div>
</div>
