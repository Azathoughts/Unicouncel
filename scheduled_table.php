...
if (isset($_SESSION['user_id'])) {
    ...
    // Fetch data from the 'scheduled_table' based on user_id
    $select = "SELECT * FROM scheduled_table WHERE user_id = '$userId'";
    $result = mysqli_query($conn, $select);

    echo "<div class='container-fluid mt-4'>";
    echo "<div class='row-fluid'>";
    echo "<div class='col-xs-12'>"; // Adjusted to use the full column width
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<tr><td colspan='12'>You have no scheduled appointments.</td></tr>"; // Message when no appointments
    }
